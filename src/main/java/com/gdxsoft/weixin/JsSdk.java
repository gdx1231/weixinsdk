...
public class JsSdk {
	...
	public String getSnsapiUserinfo(String redirect_uri, String state) {
		...
		String oath = "https://open.weixin.qq.com/connect/oauth2/authorize?appid="
				+ this.appID_
				+ "&redirect_uri="
				+ redirect_uri
	...
	/**
	 * 通过code换取网页授权 access_token 首先请注意，这里通过 code 换取的是一个特殊的网页授权 access_token, <br>
	...
	public boolean getAccessToken(String code) {
		String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid="
				+ this.appID_ + "&secret=" + this.appsecret_ + "&code=" + code
	...
	public WeiXinUser getWeiXinUserInfo() {
		String url = "https://api.weixin.qq.com/sns/userinfo?access_token="
				+ this.access_token_ + "&openid=" + this.openid_
				+ "&lang=zh_CN";
		JSONObject obj = this.getResult(url);
		if (obj == null) {
			return null;
	...
	private void initTokenParams(JSONObject obj) {
		try {
			...
			// 失效时间
			this.end_time_ = System.currentTimeMillis() + this.expires_in_
					* 1000;
